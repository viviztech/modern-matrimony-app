...
<head>
    ...
    <title>{{ isset($title) ? $title . ' - ' : '' }}{{ config('app.name', 'Matrimony') }}</title>
...
<body class="font-sans antialiased bg-gradient-to-br from-primary-50 via-white to-secondary-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 transition-colors duration-200">
    <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 px-4">
        ...
        <div class="absolute top-4 right-4">
            <button
                ...
                class="p-2 rounded-lg bg-white dark:bg-gray-800 shadow-md hover:shadow-lg transition-all duration-200"
        ...
        <!-- Content Card -->
        <div class="w-full sm:max-w-md glass dark:bg-gray-800/50 rounded-2xl shadow-xl p-8 animate-fade-in">
            <!-- Flash Messages -->
            @if (session('status'))
                <div class="mb-4 bg-success/10 border border-success/20 text-success dark:text-success-300 px-4 py-3 rounded-lg" role="alert">
