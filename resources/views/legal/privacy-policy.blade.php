            ...
            <div class="bg-white shadow-sm rounded-lg p-8">
                ...
                <div class="prose prose-blue max-w-none">
                    ...
                    <section class="mb-8">
                        ...
                        <p class="text-gray-700 mb-3">We collect the following types of personal information:</p>
                    ...
                    <section class="mb-8">
                        ...
                        <p class="text-gray-700 mb-3">We use your information for the following purposes:</p>
                        <ul class="list-disc pl-6 mb-4 text-gray-700 space-y-2">
                    ...
                    <section class="mb-8">
                        ...
                        <p class="text-gray-700 mb-3">We may share your information with third-party service providers:</p>
                        <ul class="list-disc pl-6 mb-4 text-gray-700 space-y-2">
                    ...
                    <section class="mb-8">
                        ...
                        <p class="text-gray-700 mb-3">We implement appropriate security measures to protect your information:</p>
                        <ul class="list-disc pl-6 mb-4 text-gray-700 space-y-2">
                    ...
                    <section class="mb-8">
                        <h2 class="text-2xl font-semibold text-gray-900 mb-4">6. Your Privacy Rights</h2>
                        <p class="text-gray-700 mb-3">Under GDPR and other privacy laws, you have the following rights:</p>
                        <ul class="list-disc pl-6 mb-4 text-gray-700 space-y-2">
                        ...
                        <p class="text-gray-700">
                            To exercise these rights, please contact us at <a href="mailto:privacy@{{ parse_url(config('app.url'), PHP_URL_HOST) }}" class="text-blue-600 hover:underline">privacy@{{ parse_url(config('app.url'), PHP_URL_HOST) }}</a>
                        </p>
                    </section>
                    ...
                    <section class="mb-8">
                        ...
                        <p class="text-gray-700 mb-3">We use cookies and similar technologies for:</p>
                        <ul class="list-disc pl-6 mb-4 text-gray-700 space-y-2">
                        ...
                        <p class="text-gray-700">
                            You can control cookies through your browser settings. See our <a href="{{ route('legal.cookies') }}" class="text-blue-600 hover:underline">Cookie Policy</a> for more details.
                        </p>
                    </section>
                    ...
                    <section class="mb-8">
                        ...
                        <p class="text-gray-700 mb-3">If you have questions about this Privacy Policy, please contact us:</p>
