            ...
            <div class="bg-white shadow-sm rounded-lg p-8">
                ...
                <div class="prose prose-blue max-w-none">
                    ...
                    <section class="mb-8">
                        ...
                        <p class="text-gray-700 mb-3">To use our platform, you must:</p>
                        <ul class="list-disc pl-6 mb-4 text-gray-700 space-y-2">
                            <li>Be at least 18 years old</li>
                            <li>Be legally eligible to enter into a marriage contract</li>
                            <li>Not be currently married (unless seeking a second marriage in accordance with your beliefs)</li>
                    ...
                    <section class="mb-8">
                        ...
                        <p class="text-gray-700 mb-4">
                            You must create an account to use our services. You agree to provide accurate, current, and complete
                            information during registration and keep your account information updated.
                        </p>

                        <h3 class="text-xl font-semibold text-gray-800 mb-3">3.2 Account Security</h3>
                        <p class="text-gray-700 mb-3">You are responsible for:</p>
                        <ul class="list-disc pl-6 mb-4 text-gray-700 space-y-2">
                    ...
                    <section class="mb-8">
                        ...
                        <h3 class="text-xl font-semibold text-gray-800 mb-3">4.1 Prohibited Activities</h3>
                        ...
                        <h3 class="text-xl font-semibold text-gray-800 mb-3">4.2 Content Guidelines</h3>
                        <p class="text-gray-700 mb-3">All user-generated content must:</p>
                        <ul class="list-disc pl-6 mb-4 text-gray-700 space-y-2">
                    ...
                    <section class="mb-8">
                        <h2 class="text-2xl font-semibold text-gray-900 mb-4">5. Subscription and Payments</h2>
                        <h3 class="text-xl font-semibold text-gray-800 mb-3">5.1 Subscription Plans</h3>
                        <p class="text-gray-700 mb-4">
                            We offer free and paid subscription plans. Premium features are available only to paid subscribers.
                            Subscription fees are non-refundable except as required by law.
                        </p>

                        <h3 class="text-xl font-semibold text-gray-800 mb-3">5.2 Billing</h3>
                        <ul class="list-disc pl-6 mb-4 text-gray-700 space-y-2">
                        ...
                        <h3 class="text-xl font-semibold text-gray-800 mb-3">5.3 Refund Policy</h3>
                        <p class="text-gray-700 mb-4">
                            Refunds are generally not provided except in cases of technical errors or as required by law.
                            Contact us at <a href="mailto:support@{{ parse_url(config('app.url'), PHP_URL_HOST) }}" class="text-blue-600 hover:underline">support@{{ parse_url(config('app.url'), PHP_URL_HOST) }}</a> for refund requests.
                        </p>
                    </section>

                    <section class="mb-8">
                        <h2 class="text-2xl font-semibold text-gray-900 mb-4">6. Verification</h2>
                        <p class="text-gray-700 mb-3">We offer various verification services:</p>
                        <ul class="list-disc pl-6 mb-4 text-gray-700 space-y-2">
                    ...
                    <section class="mb-8">
                        ...
                        <p class="text-gray-700 mb-4">
                            Your privacy is important to us. Please review our <a href="{{ route('legal.privacy') }}" class="text-blue-600 hover:underline">Privacy Policy</a>
                    ...
                    <section class="mb-8">
                        ...
                        <h3 class="text-xl font-semibold text-gray-800 mb-3">8.1 Our Rights</h3>
                        <p class="text-gray-700 mb-4">
                            All content, features, and functionality on {{ config('app.name') }} are owned by us and protected
                            by copyright, trademark, and other intellectual property laws.
                        </p>

                        <h3 class="text-xl font-semibold text-gray-800 mb-3">8.2 User Content</h3>
                        <p class="text-gray-700 mb-4">
                            You retain ownership of content you post. By posting content, you grant us a worldwide, non-exclusive,
                    ...
                    <section class="mb-8">
                        ...
                        <div class="bg-yellow-50 border-l-4 border-yellow-400 p-4 mb-4">
                            <p class="text-gray-800 font-semibold mb-2">IMPORTANT DISCLAIMERS:</p>
                    ...
                    <section class="mb-8">
                        ...
                        <h3 class="text-xl font-semibold text-gray-800 mb-3">11.1 By You</h3>
                        <p class="text-gray-700 mb-4">
                            You may delete your account at any time. There is a 30-day grace period during which you can
                            recover your account.
                        </p>

                        <h3 class="text-xl font-semibold text-gray-800 mb-3">11.2 By Us</h3>
                        <p class="text-gray-700 mb-3">We may suspend or terminate your account if:</p>
                        <ul class="list-disc pl-6 mb-4 text-gray-700 space-y-2">
                    ...
                    <section class="mb-8">
                        ...
                        <p class="text-gray-700 mb-3">For questions about these Terms, contact us:</p>
                        <div class="bg-gray-50 p-4 rounded-lg">
                            <p class="text-gray-700"><strong>Email:</strong> <a href="mailto:legal@{{ parse_url(config('app.url'), PHP_URL_HOST) }}" class="text-blue-600 hover:underline">legal@{{ parse_url(config('app.url'), PHP_URL_HOST) }}</a></p>
                            <p class="text-gray-700"><strong>Support:</strong> <a href="mailto:support@{{ parse_url(config('app.url'), PHP_URL_HOST) }}" class="text-blue-600 hover:underline">support@{{ parse_url(config('app.url'), PHP_URL_HOST) }}</a></p>
                ...
                <div class="mt-8 pt-6 border-t border-gray-200">
                    <div class="flex space-x-4">
                        ...
                        <a href="{{ route('legal.cookies') }}" class="text-blue-600 hover:underline">Cookie Policy</a>
